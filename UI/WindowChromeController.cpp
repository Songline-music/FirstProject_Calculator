...
// 无边框窗口绘制和交互
void CalculatorUI::applyDwmShadowForWidget(QWidget* widget, bool enabled)
{
    if (!widget) return;
    ...
    const DWMNCRENDERINGPOLICY policy = enabled ? DWMNCRP_ENABLED : DWMNCRP_DISABLED;
...
void CalculatorUI::setupNativeResizeFrame()
{
	...
	applyDwmShadowForWidget(this, true);
}
    ...
    connect(windowAnimGroup, &QParallelAnimationGroup::finished, this, [this, targetMax]()
        {
            ...
            applyDwmShadowForWidget(this, !customMaximized);
